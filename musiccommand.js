...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addStringOption(option =>
      option.setName('song')
        .setDescription('Provide the name or URL for the song or playlist.')
        .setRequired(true)
    ),
  async execute(interaction) {
    ...
    try {
      ...
      embed.setColor('Blue').setDescription('<a:music_CD_spin:1154138497100304519>  Use the buttons below to customise your listening experience.');
